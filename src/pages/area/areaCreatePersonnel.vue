    ...
    export default {
        ...
        methods: {
            add() {
                ...
                this.$router.push({name: 'areaCreatePersonnelEdit'});
            },
            // 选择
            ...
            handleAllot(id, userId) {
                ...
                this.$router.push({name: 'areaCreatePersonnelRole'});
            },
            lookDetail(id, userId) {
                sessionStorage.setItem("id", userId);
                this.$router.push({name: 'areaCreatePersonnelRoleDetails'});
            },
            // 编辑
            handleEdit(id) {
                    ...
                    if (res.data.code === 0) {
                        ...
                        for (let i = 0; i < data.length; i++) {
                            ...
                            for (let j = 0; j < data[i].roleId.length; j++) {
                                if (data[i].roleId[j] == 1) {
                                    data[i].roles.push('区教育学院管理员')
                                } else if (data[i].roleId[j] == 3) {
                                    data[i].roles.push('区教育学院学科教研员')
                                }
                            }
                        }
                        this.tableData = data;
